...
**Writing Rules**:
- Max 3 workflows for repos under 500 files; max 5 for repos 500+ files (enterprise/large codebases warrant more flow tracing)
- Max 8 steps each
...
**Pre-Read**: Yes — dispatch `agents/section-preloader.md` with the routing file, a sample feature module/component, and a service file so you can reference real file paths in each recipe.
